...
export default function ChannelsTableWrapper({ channels, token }: { channels: Channel[],token?:string }) {
  ...
  return <ChannelsDataTable columns={getChannelsColumns(editMode,updateComment)} data={data} token={token} />;
}
